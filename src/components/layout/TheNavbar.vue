    ...
    <div class="mx-auto max-w-8xl px-2 sm:px-6 lg:px-12">
      <div class="relative flex h-14 justify-between">
          ...
          <a href="/blog">
            <base-badge class="hidden lg:flex">
              <span class="hidden xl:flex">
                ✨ Read the latest Sofeware QA Python Revisited Issue!
              </span>
        ...
        >
          ...
          <a
            target="_blank"
            href="https://github.com/qdriven/qapy-revisited/tree/master"
          >
            <github-icon />
            <span class="sr-only">Software QA Python Revisited repository</span>
          </a>
        </div>
      </div>
    </div>
